      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className={`lg:grid lg:grid-cols-12 lg:gap-8 ${isRTL ? 'rtl-grid' : ''}`}>
          <div className={`text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left ${isRTL ? 'rtl-text' : ''}`}>
            ...
            <p className={`mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0 ${isRTL ? 'rtl-paragraph' : ''}`}>
              {t('hero.description')}
            </p>
            <div className={`mt-8 sm:max-w-lg mx-auto text-center lg:text-left lg:mx-0 ${isRTL ? 'rtl-buttons' : ''}`}>
              <div className={`flex flex-col sm:flex-row sm:justify-center md:justify-center lg:${isRTL ? 'justify-end' : 'justify-start'} gap-4 w-full`}>
                <a
                  href="#"
